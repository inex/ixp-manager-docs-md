...
As an example, as the time of writing, 7.1.x is the latest release and 7.2 is in development. We did **our final** push to 7.1 via:
...
Once 7.2 is released, we will push a final update to 7.2 updating it to latest:
